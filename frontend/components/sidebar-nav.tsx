...
export function SidebarNav() {
  ...
  return (
    <aside className="fixed left-0 top-0 z-40 flex h-svh w-56 flex-col overflow-hidden rounded-r-4xl border-r border-sidebar-border bg-sidebar shadow-2xl shadow-black/10">
