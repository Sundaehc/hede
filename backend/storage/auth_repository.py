...
DEFAULT_ROLES = [
    ...
    },
    {
        ...
        "name": "财务组",
        "department_code": "财务部",
        "description": "管理进销存和采购单，只读查看商品信息档案并导出物价",
        "permissions": "product.view,product.price_export,inventory.view,inventory.manage,inventory.export,purchase.view,purchase.manage,purchase.export",
    },
    {
        "code": "product_user",
        "name": "商品组",
        "department_code": "商品部",
        "description": "维护商品档案和采购单，可新增、编辑和删除供应商，允许精细表导出",
        "permissions": "product.view,product.manage,product.import,product.export,fine_table.view,fine_table.export,purchase.view,purchase.manage,purchase.import,purchase.export,inventory.view,supplier.create,supplier.manage",
    },
    {
        "code": "operation_user",
        "name": "运营组",
