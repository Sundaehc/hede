...
PRODUCT_FIELDS: tuple[FieldSpec, ...] = (
    ...
    FieldSpec("rear_heel_height", "后跟高"),
    FieldSpec("sole_style", "跟底款式", aliases=("根底款式",)),
    ...
    FieldSpec("upper_height", "鞋帮", aliases=("鞋帮高度",)),
    FieldSpec("opening_depth", "开口深度"),
    FieldSpec("boot_shaft", "靴筒"),
    FieldSpec("toe_shape", "鞋头", aliases=("鞋头款式",)),
    FieldSpec("closure_type", "闭合方式"),
    FieldSpec("mesh_upper_type", "鞋网面类型", aliases=("鞋面类型",)),
