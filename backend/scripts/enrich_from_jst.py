...
FILE_BRAND_MAP = {
    "千百度聚水潭商品表最新.xlsx": ["qbd_mens", "qbd_womens"],
    "千百度福建聚水潭商品表（最新）.xlsx": ["qbd_mens"],
    "京东分销聚水潭商品表最新.xlsx": ["qbd_mens"],
    "千百度拖鞋聚水潭商品表.xlsx": ["qbd_mens", "qbd_womens"],
    "千百度女鞋聚水潭商品表最新 - 副本.xlsx": ["qbd_womens"],
    "千百度女鞋R组聚水潭商品表最新.xlsx": ["qbd_womens"],
    "烟斗聚水潭商品表（最新）.xlsx": ["yandou"],
    "烟斗福建聚水潭商品表（最新）.xlsx": ["yandou"],
    "伊伴聚水潭商品表（最新）.xlsx": ["yiban"],
    "伊伴女鞋聚水潭商品表（最新）.xlsx": ["yiban"],
    "伊伴福建聚水潭商品表（最新）.xlsx": ["yiban"],
    "伊伴女鞋桐乡聚水潭商品表.xlsx": ["yiban"],
}
