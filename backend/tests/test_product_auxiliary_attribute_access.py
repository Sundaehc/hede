...
def _request() -> Request:
    scope = {
        "type": "http",
        "method": "GET",
        "path": "/product-auxiliary-attributes",
        "headers": [],
        "app": SimpleNamespace(
...
async def test_auxiliary_attribute_management_allows_authorized_departments(
...
async def test_auxiliary_attribute_management_rejects_other_departments(
